...
# From https://github.com/forcecore/Keras-GAN-Animeface-Character/blob/master/discrimination.py
...
class MinibatchDiscrimination(Layer):
    ...
    def __init__(self, nb_kernels, kernel_dim=5, init='glorot_uniform', weights=None,
