...
#sbatch submit_likelihood.sh $model $path"HToZATo2L2B_MH-$max_MA-200_signal_weights.root"      $number $max
#sbatch submit_likelihood.sh $model $path"HToZATo2L2B_MH-$max_MA-500_signal_weights.root"      $number $max
#sbatch submit_likelihood.sh $model $path"HToZATo2L2B_MH-$max_MA-50_signal_weights.root"       $number $max
