...
namespace HToZA_3000_2000_2HDM4MG5_may15 
{
    ...
    & vertex)
{
  ...
  P3[2] = S3[1].imag(); 
  P3[3] = S3[0].imag(); 
  TMP5 = (P3[0] * V1[2] - P3[1] * V1[3] - P3[2] * V1[4] - P3[3] * V1[5]); 
  TMP4 = (P2[0] * V1[2] - P2[1] * V1[3] - P2[2] * V1[4] - P2[3] * V1[5]); 
  vertex = COUP * S2[2] * S3[2] * (-cI * (TMP4) + cI * (TMP5)); 
}


}  // end namespace $(namespace)s_2HDM4MG5_may15
